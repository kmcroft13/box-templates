...
<html lang="en">
<head>
    <title>Code coverage report for lib/event-stream.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> event-stream.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (data.message !== 'new_change') {
<span class="cstat-no" title="statement not covered" >			self.doLongPoll();</span>
 ...
 * @returns {void}
 */
EventStream.prototype._read = <span class="fstat-no" title="function not covered" >function() {</span>
&nbsp;
	// Start the process of getting new events
<span class="cstat-no" title="statement not covered" >	this.getLongPollInfo();</span>
};
&nbsp;
