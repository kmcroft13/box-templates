...
<html lang="en">
<head>
    <title>Code coverage report for lib/util/errors.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/util/</a> errors.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	 ...
	 * should be called and the error should be propogated to the consumer callback
	...
	buildUnexpectedResponseError: function(response) {
		response = response || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
