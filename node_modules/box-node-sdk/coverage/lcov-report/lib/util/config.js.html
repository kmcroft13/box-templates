...
<html lang="en">
<head>
    <title>Code coverage report for lib/util/config.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/util/</a> config.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	if (typeof appAuth.algorithm !== 'undefined') {
		assert(appAuth.algorithm === 'RS256' || <span class="branch-1 cbranch-no" title="branch not covered" >appAuth.algorithm === 'RS384' </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >appAuth.algorithm === 'RS512',</span> 'Valid algorithm must be provided in app auth params');
	}
&nbsp;
	if (typeof appAuth.expirationTime !== 'undefined') {
		assert(typeof appAuth.expirationTime === 'number' &amp;&amp; appAuth.expirationTime &gt; 0, 'Valid token expiration time must be provided in app auth params');
	}
}
&nbsp;
// ------------------------------------------------------------------------------
